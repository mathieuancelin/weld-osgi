...
public class CDIOSGiProducer {
        ...
        if (bundleName == null || bundleName.value().equals("")) {
            ...
            if (bundleVersion == null || bundleVersion.value().equals("")) {
                return (Bundle) Proxy.newProxyInstance(getClass().getClassLoader(),
                    ...
                    new BundleHandler(bundleName.value(), "", holder.getContext()));
            }
            return (Bundle) Proxy.newProxyInstance(getClass().getClassLoader(),
                new Class[] {Bundle.class},
                new BundleHandler(bundleName.value(), bundleVersion.value(), holder.getContext()));
        }
    }
    ...
    @Produces @BundleName("") @BundleVersion("") @BundleHeaders
    ...
    @Produces @BundleName("") @BundleVersion("") @BundleHeader("")
    public String getSpecificBundleHeader(BundleHolder holder, InjectionPoint p) {
        ...
        if (header == null || header.value().equals("")) {
            IllegalStateException e = new IllegalStateException("The BundleHeader qualifier was missing or its value was null");
    ...
    private static class BundleHandler implements InvocationHandler {
        ...
        public BundleHandler(String symbolicName, String version, BundleContext context) {
            logger.debug("Bundle reference {}:{} produced", symbolicName, version.equals("")?"no_version_provided":version);
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (bundle == null) {
                logger.warn("Bundle {}:{} is unavailable", symbolicName, version == null?"no_version_provided":version);
                return null;
            }
